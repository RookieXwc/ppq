...
ENGINE_PATH      = 'outputs/yolov5s.v5(ppq).onnx'  # 生成的 Engine 位置
...
with ENABLE_CUDA_KERNEL():
    ...
    export_ppq_graph(
        ...
        config_save_to='outputs/quant_cfg.json')

    build_engine(onnx_file='outputs/yolov5s.v5(ppq).onnx', int8_scale_file='outputs/quant_cfg.json', engine_file='outputs/yolov5s.v5(ppq).engine',
                 int8=True)