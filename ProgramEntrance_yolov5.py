"""对官方 PPQ 量化的入口脚本进行修改支持yolov5，将模型和数据按要求进行打包:

    ~/working/model.onnx                          <--  your model
    ~/working/data/*.png or *.jpg                 <--  your dataset
...
from ppq.api import *
import os
from yolov5_utils import load_calibration_dataset_yolov5, non_max_suppression

# modify configuration below:
WORKING_DIRECTORY = 'working_yolov5'                             # choose your working directory
...
# -------------------------------------------------------------------
dataloader = load_calibration_dataset_yolov5(
